...
// PUT items/:id
exports.itemsRouter.put("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, itemUpdate, existingItem, updatedItem, newItem, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = parseInt(req.params.id, 10);
            ...
            case 3:
                updatedItem = _a.sent();
                return [2 /*return*/, res.status(200).json(updatedItem)];
            case 4: return [4 /*yield*/, ItemService.create(itemUpdate)];
            case 5:
                newItem = _a.sent();
                res.status(201).json(newItem);
                return [3 /*break*/, 7];
